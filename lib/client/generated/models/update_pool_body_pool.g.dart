...
part of 'update_pool_body_pool.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

UpdatePoolBodyPool _$UpdatePoolBodyPoolFromJson(Map<String, dynamic> json) =>
    UpdatePoolBodyPool(
...
Map<String, dynamic> _$UpdatePoolBodyPoolToJson(UpdatePoolBodyPool instance) =>
    <String, dynamic>{
      'name': instance.name,
