...
@JsonEnum()
enum ModActionAction {
  @JsonValue('admin_user_delete')
  ...
  @JsonValue('staff_note_create')
  staffNoteCreate('staff_note_create'),
  @JsonValue('staff_note_update')
  staffNoteUpdate('staff_note_update'),
  @JsonValue('staff_note_delete')
  staffNoteDelete('staff_note_delete'),
  @JsonValue('staff_note_undelete')
  staffNoteUndelete('staff_note_undelete'),
  ...
  @JsonValue('tag_destroy')
  tagDestroy('tag_destroy'),
  ...
  @JsonValue('user_uploads_toggle')
  userUploadsToggle('user_uploads_toggle'),
  ...
  @JsonValue('user_flush_favorites')
  userFlushFavorites('user_flush_favorites'),
  ...
  @JsonValue('post_version_hide')
  postVersionHide('post_version_hide'),
  @JsonValue('post_version_unhide')
  postVersionUnhide('post_version_unhide'),
  /// Default value for all unparsed values, allows backward compatibility when adding new values on the backend.
  $unknown(null);

  const ModActionAction(this.json);

  factory ModActionAction.fromJson(String json) => values.firstWhere(
        (e) => e.json == json,
        orElse: () => $unknown,
      );
  ...
  static List<ModActionAction> get $valuesDefined => values.where((value) => value != $unknown).toList();
}
